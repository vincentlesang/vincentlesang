...
<div style="width:700px; height: 400px; padding: 10px 20px 5px;
            border-radius: 40px; 
            background: #ecf0f3;
...
<div style="display: inline-block; top: 50px; width:52.5px; height: 52.5px;   
            border-radius: 50%; 
            overflow: hidden;
            position: relative;
            left: 225px;
...
<div style="display: inline-block; top: 100px; width:157.5px; height: 90px;  
            border-radius: 60px; 
            position: relative;
            left: 20px;
            background: #FF0000;
